...
('Andrey Ferreira Mechute', 'Andrey é um cara robotico que joga bem todos os jogos do universo');

/* Configura e inicializa a estrutura de dados para o programa rodar quando ele conecta no banco de dados utilizando um ORM */